...
|**Учасники:**           | Співробітник; Система; Адміністратор                          |
|**Передумови:**         | Запит до адміністратора на реєстрацію нового співробітника    |
|**Результат:**          | Успішна реєстрація                                            |
|**Виключні ситуації:**  | Невірно заповнена анкета, кандидат не підходить під 		 |
|                        | мінімальні критерії, така людина вже зареєстрована в системі  |
|**Основний сценарій:**  | 
