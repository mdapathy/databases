...
|**Передумови:**         | Інформація, сформована редактором,    профілі працівників     |
|**Результат:**          | База даних                                                    |
|**Виключні ситуації:**  | -                             				 |
|**Основний сценарій:**  | 1. Адміністратор формує базу даних за наданою редакторами     |
|                        | інформацією та профілями працівників сайту			 |
...
|**Виключні ситуації:**  | Некоректно заповнений запит від редактора                     |
|**Основний сценарій:**  | 1. Редактор створює запит системі на зміну актуальності       |
|			 | інформації 							 |
|			 | 2. Система передає запит адміністратору                       |
|	 	         | 3. Адміністратор змінює статус актуальності інформації        |
|                        | в системі      						 |
...
|**Основний сценарій:**  | 1. Керівник відділу передає системі запит на створення нового |
|			 | профілю працівника      					 |
|			 | 2. Cистема передає запит адміністратору 			 |
|			 | 3. Адміністратор підтверджує створення нового профілю	 | 
