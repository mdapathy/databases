...
**[9. Діаграма бізнес сутності](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/StakeholderRequests.md#9-%D0%B4%D1%96%D0%B0%D0%B3%D1%80%D0%B0%D0%BC%D0%B0-%D0%B1%D1%96%D0%B7%D0%BD%D0%B5%D1%81-%D1%81%D1%83%D1%82%D0%BD%D0%BE%D1%81%D1%82%D1%96)**
...
**[11. Use cases](https://github.com/mdapathy/databases/blob/master/Документація/StakeholderRequests.md#11-use-cases)**

**[12. EER diagram](https://github.com/mdapathy/databases/blob/master/Документація/StakeholderRequests.md#12-eer-diagram)**
...
**DDF**- це концептуальна модель даних, що не має певного формату. Але для її використання необхідно визначити можливі формати даних, котрими є ***DDFcsv*** та ***DDFmongo***.

**DDFcsv** є табличним представленням даних DDF у відомому форматі розділених комою значень (csv), є зрозумілим як для людини, так і для комп'ютера.


**DDFmongo** це представлення DDF у вигляді бази даних mongo, використовується для [Gapminder tools](https://www.gapminder.org/tools/#$state$marker$select@$country=bgd&trailStartTime=2018;;;;&chart-type=bubbles).


#### Короткий опис

DDF використовується для визначення наборів даних. Набір даних - це сукупність *узгоджених, пов'язаних даних*, які складаються з окремих елементів, котрими можна керувати за допомогою комп`ютера як одним цілим . Кожен набір даних DDF визначає ***п'ять колекцій*** даних:**Поняття/Концепти(Concepts), Метадані (Metadata), Сутності (Entities), Датапоінти (Datapoints) та Синоніми (Synonyms).**

Нижче коротко визначено різницю між кожною з них.

1. **Датапоінти** містять багатовимірні дані.

   *Населення чоловіків у Німеччині в 2015 році склало 293958.*

2. **Сутності** містять одновимірні дані.

   *Офіційною повною назвою Німеччини є Федеративна Республіка Німеччина.*

3. **Метадані** містять додаткову інформацію про дані.

   *Джерелом для всіх даних про населення Німеччини в 2015 році (як чоловіків, так і жінок) є центральне бюро статистики в Німеччині, а точність даних- 95%.*

   *Джерелом даних про те, що Гонконг є китайською провінцією, є китайський уряд.*

4. **Концепти/Поняття** містять інформацію про змінні в наборі даних (тобто заголовки стовпців при табличному представленні).

	*Популяція вимірюється в одиницях населення і повинна бути більше 0.*

5. Синоніми містять набори слів, що використовуються для ідентифікації **Сутностей** і **Понять/Концептів** в інших наборах даних. Вони використовуються для гармонізації наборів даних з різних джерел до одного узгодженого набору даних.

*Країна Німеччина має синоніми “ger”, “deu”, “de”, “Bundesrepublik Deutschland” та “Федеративна Республіка Німеччина”.

Набір даних **повинен** мати ***Концепцти/Поняття*** і **може** мати ***Датапоінти, Сутності, Метадані або Синоніми.***

### Унікальні пари ключ-значення

Кожна з колекцій складається з пар ключ-значення. Кожна пара ключ-значення є **унікальною для всього набору даних.**

Конкретний приклад: *В одному наборі даних може існувати тільки одне значення для: Населення Німеччини в 2015 році, офіційної повної назви Німеччини, одиниця виміру для населення або джерело всіх даних про населення для Німеччини у 2015 році.*


### Датапоінти

Дані зберігаються в датапоінтах у вигляді пар ключ-значення. Ключ складається з двох або більше вимірів в той же час значення складаєтсья з одного індикатора.

Наприклад, необхідні ключі рік та країна для визначення значення кількості населення, ВВП тощо.


### Концепти/Поняття

Концепти є заголовками таблиць у будь-якому місці набору даних DDF. Властивості концептів - це поняття, які дають інформацію про концепти. 

Будь-які властивість будь-якого концепту можуть бути визначені в DDF. Всі поняття, що використовуються в наборі даних, повинні бути перераховані і будь-яка властивість цих понять може бути визначена в цьому переліку. 

### Метадані

Метадані - це дані про дані. Наприклад: чоловіче населення Швеції в 2015 році становить 99483857. Це дані. Метаданими для цих даних будуть їх джерело (статистика населення ООН), точність (5%) та примітки. Жіноче населення Швеції в 2015 році може мати інше джерело, точність та примітку. Те ж саме для тих же даних за 2016 рік.

Метадані можуть бути такими деталізованими, як опис одного конкретного числа в наборі даних, одне значення датапоінтів. Тому в DDF ми визначаємо метадані як властивість однієї пари ключ-значення даних у наборі. 
...
### 6.2 Сценарій «Видалення інформації менеджером даних»
...
| **Назва :**            | Видалення інформації за запитом модератора           |
|**Учасники:**           | Модератор; Менеджер даних; Система                            |
|**Передумови:**         | Рішення модератора про видалення певного контенту    |
|**Результат:**          | Видалення даних                                               |
|**Виключні ситуації:**  | Модератор не підтвердив видалення інформації                       				 |
|**Основний сценарій:**  | 1. Менеджер даних формує запит на видалення інформації       |
|			 | 2. Менеджер даних відправляє запит на видалення системі  |
|			 | 3. Система передає  запит модератору|
|			 | 4. Модератор передає системі підтвердження запиту|
|		         | 5. Cистема видаляє дані       	        |
|		         | 6. Система повідомляє менеджера даних про видалення інформації      	        |
...
| 			 | 4. Система надсилає набір даних модератору.|
|			 | 5. Модератор надсилає системі підтвердження про створення цього набору даних|
|			 | 6. Система зберігає набір даних			 |
| 			 | 7. Система надсилає модератору повідомлення про створення набору даних|
...
|			 | 2. Менеджер даних поновлює інформацію.|
|			 | 3. Менеджер даних надсилає системі поновлену інформацію|
|			 | 4. Cистема надсилає інформацію модератору|
|			 | 5. Модератор надсилає системі підтвердження про оновлення  інформації|
|			 | 6. Система зберігає інформацію			 |
| 			 | 7. Система надсилає модератору повідомлення про поновлення інформації|
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/diag.jpeg)
...
### 10.2.1  Модератор
   ...
   • Дає завдання на створення нового набору даних Менеджеру даних
   
   • Регулює роботу профілів користувачів системи
   
   • Зворотній зв’язок із Менеджером даних
...
### 10.2.3  Клієнт
  ...
  • Доступ до системи в будь-який час без попередньої реєстрації та вільне користування вмістом
...
|                 |                                                           |
|-----------------|-----------------------------------------------------------|
|**Ідентифікатор**	  | AF-2.1		         	       		      |
|**Назва**		  | Формування набору даних                            |
|**Учасники**	  | Модератор, Система, Менеджер даних                        |
|**Передумови**	  | Необхідність створення нового набору даних	                              |
|**Результат**	  | Набір даних			      |
|**Виключні ситуації**| -				                              |
|**Опис**         | 1. Модератор дає завдання менеджеру даних на створення нового набору даних|
||2. Менеджер даних формує набір даних. Набір даних для системи формується у вигляді DDF моделі, спеціальної моделі, що використовується для представлення наборів даних (datasets). Dataset DDF визначає п'ять колекцій даних: поняття (Concepts) , метадані(Metadata), сутності( Entities), дані(Datapoints) та синоніми(Synonyms). Набір даних повинен мати Concept і може мати DataPoints, Entities, Metadata або Synonyms. Кожна з цих колекцій складається з пар ключ-значення. Кожна пара ключ-значення унікальна у всьому наборі даних.|
||3. Менеджер даних вводить у систему сформований набір даних. Для цього у меню необхідно вибрати пункт “Створити новий набір даних”.  Далі вводимо назву набору даних у полі “Назва”. Задаємо поняття (Concepts) (вони будуть заголовками колонок у таблиці) та  Concept type (типи даних, що будуть підлягати даним поняття (Concept)). Стовбці з відповідними поняттями (Concept) заповнюються даними. Строки, що утворюються у таблиці, є  Datapoints.Також можливо додати  метадані й синоніми, вибравши відповідні вкладки у вікні створення нового набору данних.|
||4. Менеджер даних надсилає системі набір даних. Для цього треба натиснути кнопку “Збереження”.|
||5. Система надсилає набір даних модератору. Збереження призведе до того, що у базу даних буде додано новий набір даних, який стане доступним модератору.
||6. Модератор надсилає системі підтвердження про створення цього набору даних. Модератор перевіряє правильність створеного набору даних. Якщо все відповідає вимогам, то модератор може опублікувати новий набір даних натиснувши “Опублікувати”. | 
|| 7. Система зберігає набір даних. Після публікації система додає набір даних у перелік доступних для перегляду користувачами.|
|| 8. Система надсилає модератору повідомлення про створення набору даних. У вікні з переліком наборів даних статус даного набору змінюється на “Опубліковано”.|
|||
...
|**Результат**	  | Оновлена інформація в системі			      |
|**Виключні ситуації**| -				                              |
|**Опис**             | 1. Модератор авторизується у свій особистий кабінет на сайті, ввівши унікальне ім’я користувача, пароль і натиснувши кнопку «Увійти». У кабінеті через внутрішні зв’язки (розділ кабінету «Комунікації») дає відповідні вказівки на операції з даними Менеджеру даних, заповнивши усі поля форми «Створити завдання», а саме «Назва», «Опис», «Виконавець», «Закінчити до». Модератор підтверджує усі введені дані, натиснувши кнопку «Підтвердити».|
||2. Після авторизації в особистий кабінет, Менеджер даних отримує сповіщення у вкладці «Комунікації» про наявність нового завдання. Ознайомившись із описом завданням, Менеджер даних підтверджує отримання вказівок, натиснувши кнопку «Підтвердити». Далі Менеджер даних збирає усі необхідні дані, які необхідні для виконання завдання. |
||3. Після того, як Менеджер даних має готовий оновлений набір даних, він заходить у вкладку особистого кабінету «Комунікації» і вводить усі зібрані дані у відповідь на створене завдання Модератором. Підтверджує введені дані, натиснувши кнопку «Відправити».|
||4. Система сповіщує особистий кабінет Модератора про те, що з’явилась відповідь на створене ним раніше завдання. Після того, як Модератор авторизується в особистий кабінет, він побачить сповіщення у вкладці «Комунікації».|
||5. Модератор підтверджує виконання завдання, натиснувши кнопку «Зaвершити завдання та оновити інформацію», попередньо вказавши, яку саму частину існуючого набору даних потрібно оновити у відповідних полях форми.
||6. Система оновлює існуючий набір даних, після чого для усіх відвідувачів ресурсу буде відображатись оновлений набір даних.| 
|| 7. Після успішного оновлення даних, Система сповіщує особисті кабінети Модератора та Менеджера даних про те, що дані були успішно оновлені. Це сповіщення учасники можуть побачити у вкладці «Комунікації» особистого кабінету, після чого виконання завдання на оновлення інформації можна вважати завершеним.|
|||
...
|**Виключні ситуації**| Адміністратор не підтвердив видалення профілів, в системі не існують профілі,що задовольняють критерії |
|**Опис**            | |
||1.Після авторизації адміністратором в системі, він заходить в розділ «Персонал» і натискає на кнопку «Видалення персоналу», де вказує дату і натискає на кнопку «Знайти», після чого очікує результати від системи.|
||2. Система відбирає всі профілі, які не заходили в систему до вказаної адміністратором дати і створює список, який має такі колонки: «Ім’я», «Нікнейм», «Посада», «Дата реєстрації», «Дата останнього входу в систему», де вказані відповідні дані відібраних профілів, і правіше ще додається елемент ChekBox.|
||3.Система утворений список відображає на екрані адміністратора.|
||4.Адміністратор за допомогою ChekBox-ів відмічає профілі, які потрібно видалити, після чого натискає на кнопку «Підтвердити» і очікує результати видалення.|
||5.Система відбирає профілі, які були відмічені адміністратором за допомогою ChekBox-ів і видаляє їх з системи.| 
||6.Система відправляє адміністратору повідомлення про успішне видалення профілів з системи.|
|||
...
|                       |                                                                |
| ----------------------|----------------------------------------------------------------|
| **Ідентифікатор**     | AF- 2.4                                               		        |
| **Назва**            | Надання профілю співробітника прав адміністратора   		  |
|**Учасники**           | Адміністратор; Система;	               			  |
|**Передумови**         | Запит від адміністратора до системи на надання прав адміністратора  |               	
|**Результат**          | Отримання профілем прав адміністратора                         |
|**Виключні ситуації**  | Профіль вже має права адміністратора, профіль не є співробітником сервісу	|
|**Опис**               | 1.Після авторизації адміністратором в системі, він заходить в розділ «Персонал» і натискає на кнопку «Надати права адміністратора», після чого відображається форма, в якій адміністратор вводить Ім’я та нікнейм профілю, якому він хоче надати права адміністратора, і натискає на кнопку «Підтвердити» і очікує результати роботи системи.|
||2.Система зчитує вказані дані адміністратором і перевіряє на наявність зазначеного профілю|
||3.Система змінює інформацію про посаду вибраного профілю на «Адміністратор».||
||4.Система відображує адміністратору повідомлення про успішне надання вказаному профілю права адміністратора.|


|                        |                                                               |
| -----------------------|---------------------------------------------------------------|
| **Ідентифікатор:**     | AF- 2.5                                              		       |
| **Назва :**            | Порушення протоколів безпеки доступу				 |
|**Учаcники:**           | Система; Адміністратор;					 |
|**Передумови:**         | Порушення протоколів безпеки доступу				 |
|**Результат:**          | Блокування ресурсу, повідомлення адміністратору.		 |
|**Виключні ситуації:**  | Тотальний збій системи при атаці на програмне забезпечення, блокування доступу до інформації на невизначений термін,  недієздатність адміністратора.				 |
| **Опис**   		 | 1.Система блокує доступ до ресурсу при порушенні протоколів безпеки доступу. Такими порушеннями можуть бути: неправильно введені дані при спробі зайти у власний профіль, спроба отримання та редагування інформації без потрібного дозволу.|
||2.Система зберігає інформацію про спробу неправомірного запиту доступу.||
||3.Система надсилає повідомлення адміністратору про порушення протоколів безпеки доступу.|
...
|**Результат:**          | Відповідь клієнту     	                                 |
|**Виключні ситуації:**  | Неправильно заповнена форма запиту				 |
|**Опис**		 | 1. Після авторизації клієнта в системі, він натискає на кнопку «Допомога», після чого у вікні, що з’явилося, описує проблему, що виникла, та натискає кнопку «Відправити», після чого очікує результати від системи.|
||2.Система отримує запит та перенаправляє його адміністратору.|
||3.Адміністратор отримує запит та аналізує його. Після аналізу адміністратор формує вичерпну відповідь на отриманий запит та перенаправляє її системі.|
||4.Система отримує відповідь від адміністратора та перенаправляє її клієнту. |
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/eer.jpeg)
