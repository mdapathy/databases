...
|**Учасники:**           | Менеджер даних; Модератор; Адміністратор;                      |
...
|**Основний сценарій:**  | 1. Адміністратор передає за допомогою системи запит на створення нової бази даних модератору       |
|                        | 2. Модератор дає за допомогою системи завдання менеджеру даних на формування нової бази даних   |
| 		         | 3. Менеджер даних вибирає датапоінти, формує сущність, прописує метадату, синоніми та концепти на основі знайденої/отриманої інформації                 |
|                        | 4. Менеджер передає створену базу модератору			    |
|			 | 5. Модератор перевіряє отриману інформацію. В разі необхідності передає базу знов на правки менеджеру|
|			 | 6. Модератор затверджує створену базу		            |
|			 | 7. Менеджер зберігає нову базу даних у системі		    |
...
|**Основний сценарій:**  | 1. Готові форми модератор відправляє за допомогою системи адміністратору.   |
|                        | 2. На основі форм, адміністратор формує профіль та надає права на редагування контенту у системі   |                   |
...
|			 | 3. Адміністратор формує запит на видалення                 |
|		         | 4. Адміністратор передає запит за допомогою системи модератору               |
|			 | 5. Модератор видаляє дані з системи                     |
...
|			 | 2. Адміністратор передає за допомогою системи запит модератору  |
|		         | 3. Модератор видаляє данні з системи         	         |
...
### 10.1. Можливості зацікавлених осіб.



### 10.1.1. Можливості Адміністратора.


1. Спостереження за системою, її оцінка.

2. Оповіщення про роботу системи.

3.  Внесення змін в систему даних, що підкріпленні задокументованими запитами редакторського складу або керівниками відділів.

4. Підтримка системи в робочому стані.



### 10.1.2. Можливості клієнтів.


1. Санкціонований доступ до ресурсів сервісу.

2. Можливість проведення обслуговування ресурсу клієнтом (співробітником).
