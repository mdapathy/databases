...
Права по керуванню системою належать **адміністратору**, **модератору** та **менеджеру даних**. Адміністратор керує базою співробітників, приймає рішення про додання чи видалення інформації. Модератор керує менеджарами даних, видаляє інформацію за наказом адміністратора. Менеджери даних опрацьовують данні, створюють бази даних, редагують їх. В інших аспектах система діє *самодостатньо*, та накопичує дані своєї експлуатації. Клієнти ніяким чином не впливають на систему.


## 6. Сценарії бізнес-процесів

### 6.1 Сценарій «Додавання нової інформації до системи»
...
| **Назва :**            | Додавання нової інформації до системи                           |
|**Учасники:**           | Менеджер даних; Модератор; Адміністратор; Система                     |
|**Передумови:**         | Інформація, знайдена менеджером даних                          |
|**Результат:**          | Нова база даних у системі                                                |
|**Виключні ситуації:**  | Нездатність забезпечити необхідною кількістю місця на сервері  |
|**Основний сценарій:**  | 1. Адміністратор відправляє системі запит на створення нової бази даних |
|                        | 2. Система передає запит модератору|
| 		         | 3. Модератор дає завдання менеджеру даних на формування нової бази даних|
|                        | 4. Менеджер даних ...|
|			 | 5. Менеджер передає створену базу модератору|
|			 | 6. Модератор перевіряє отриману інформацію		            |
|			 | 7. Модератор затверджує створену базу         		    |
|			 | 8. Менеджер додає дані до системи |
|			 | 9. Система зберігає базу даних |
 



### 6.2. Сценарій «Реєстрація співробітника»
...
|**Передумови:**         | Коректно заповнені форми на реєстрацію                         |
|**Результат:**          | Профіль співробітника, права на редагування інформації         |
|**Виключні ситуації:**  | Некоректно заповненні форми                                    |
|**Основний сценарій:**  | 1. Готові форми модератор відправляє  адміністратору.   |
|                        | 2. На основі форм, адміністратор формує профіль та надає права на редагування контенту у системі   |          |			  | 3. Адміністратор додає готовий профіль в систему		   |




### 6.3 Сценарій «Видалення інформації за запитом представника ресурсу даних»
...
| **Назва :**            | Видалення інформації за запитом представника ресурсу даних     |
|**Учасники:**           | Представник ресурсу даних; Модератор; Адміністратор;   |
|**Передумови:**         | Заява представника                                             |
|**Результат:**          | Видалення інформації                                           |
|**Виключні ситуації:**  | Некоректно   заповнена заява, відмова адміністратора           |
|**Основний сценарій:**  | 1. Представник ресурсу даних передає заяву адміністратору      |
|			 | 2. Адміністратор опрацьовує запит                          |
|			 | 3. Адміністратор формує запит системі на видалення                 |
|		         | 4. Адміністратор відправляє запит на видалення системі               |
|			 | 5. Система передає даний запит модератору |
|			 | 6. Модератор видаляє дані з системи                     |


### 6.4 Сценарій «Видалення інформації за запитом адміністратора»

|                        |                                                               |
| -----------------------|---------------------------------------------------------------|
| **Ідентифікатор:**     | **[AF- 1.4](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/StakeholderRequests.md#af---14)**           			                                       |
| **Назва :**            | Видалення інформації за запитом головного редактора           |
|**Учасники:**           | Адміністратор; Модератор;                             |
|**Передумови:**         | Рішення головного редактора про видалення певного контенту    |
...
|			 | 3. Система передає даний запит модератору|
|		         | 4. Модератор видаляє данні з системи         	         |


### 6.5 Сценарій «Перегляд інформації бази даних клієнтом»

|                        |                                                               |
| -----------------------|---------------------------------------------------------------|
| **Ідентифікатор:**     | **[AF- 1.5]**           			                                       |
...
### 7.1 Сценарій «Формування бази даних»
...
| **Назва :**            | Формування бази даних 					 |
|**Учасники:**           | Адміністратор; Система; Модератор                             |
|**Передумови:**         | Інформація, сформована менеджерами ресурсів, профілі працівників|
|**Результат:**          | База даних                                                    |
|**Виключні ситуації:**  | -                             				 |
|**Основний сценарій:**  | 1. Модератор надає адміністратору інформацію, сформовану менеджерами ресурсів|
|			 | 2. Адміністратор формує базу даних 



### 7.2 Сценарій «Зміна актуальності інформації в системі»
...
|**Учасники:**           | Модератор; Система; Менеджер ресурсів                         |
|**Передумови:**         | Запит менеджера до модератора      			         |
|**Результат:**          | Зміна актуальності інформації                                 |
|**Виключні ситуації:**  | Некоректно заповнений запит від менеджера ресурсів            |
|**Основний сценарій:**  | 1. Менеджер ресурсів створює запит модератору на зміну актуальності інформації|
|			 | 2. Система передає запит модератору			         |
|			 | 3. Модератор підтверджує запит				 |
| 			 | 3. Система дає дозвіл менеджеру ресурсів на зміну актуальності інформації|



### 7.3 Сценарій «Реєстрація нового співробітника сервісу»
...
|**Передумови:**         | Запит адміністратора на реєстрацію нового співробітника    |
|**Результат:**          | Успішна реєстрація                                            |
|**Виключні ситуації:**  | Така людина вже зареєстрована в системі, адміністратор не 	 |
|			 | підтвердив створення профілю		         		 |
|**Основний сценарій:**  | 1. Адміністратор передає системі запит на створення нового    |
|			 | профілю працівника      					 |
|			 | 2. Cистема оброблює запит і створює новий профіль		 |
|			 | 3. Система відправляє адміністратору підтвердження про успішне створення профілю| 



### 7.4 Сценарій «Видалення неактивного профілю»
...
| **Назва :**            | Видалення неактивного профілю     				 |
|**Учасники:**           | Адміністратор; Система;	                                 |
|**Передумови:**         | Запит адміністратора до системи на видалення профілів,    	 |
|                        | які були неактивні більше заданого терміну                    |
|**Результат:**          | Видалення профілів.                                           |
|**Виключні ситуації:**  | Адміністратор не підтвердив  видалення профілів, в системі не |
|		   	 | існують профілі,що задовольняють критерії 			 |
|**Основний сценарій:**  | 1. Адміністратор надає запит системі на видалення неактивних  |
|			 | протягом певного  часу профілів 		         	 |
|    			 | 2. Система шукає профілі, які задовольняють критерії   	 |
|			 | 3. Система передає адміністратору список відповідних профілів |
|		         | 4. Адміністратор надсилає системі підтвердження на видалення   |
|			 |  профілів 							 |
|			 | 5. Система видаляє профілі					 |



### 7.5 Сценарій «Надання профілю співробітника прав адміністратора»
...
|**Учасники:**           | Адміністратор; Система;	               			  |
|**Передумови:**         | Запит від адміністратора до системи на надання прав  	  |
|			 | адміністратора                   				  |
|**Результат:**          | Отримання профілем прав адміністратора                         |
|**Виключні ситуації:**  | Профіль вже має права адміністратора, 			  |
|			 | профіль не є співробітником сервісу				  |
|**Основний сценарій:**  | 1. Адміністратор надсилає системі запит на надання профілю прав|
| 			 | адміністратора.						  |
|			 | 2. Система обробляє запит і перевіряє наявність зазначеного    |
|			 | профілю							  |
|			 | 3. Система надає профілю права адміністратора          	  |
| 			 | 4. Система надсилає повідомлення адміністратору про  	  |
|			 | завершення виконання запиту					  |



### 7.6 Сценарій «Порушення протоколів безпеки доступу»
...
|**Виключні ситуації:**  | Тотальний збій системи при атаці на програмне забезпечення,   |
| 			 | блокування доступу до інформації на невизначений термін,      |
|			 | недієздатність адміністратора.				 |
|**Основний сценарій:**  | 1. Система блокує доступ до ресурсу при порушенні протоколів  |
|		         | безпеки доступу.						 |
| 			 | 2. Система веде запис неправомірних запитів доступу.		 |
|			 | 3. Система повідомляє про порушення протоколу безпеки    	 |
|			 | доступу адміністратора.					 |



### 7.7 Сценарій «Перегляд інформації бази даних клієнтом»

|                        |                                                               |
| -----------------------|---------------------------------------------------------------|
| **Ідентифікатор:**     | **[AF- 2.7](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/StakeholderRequests.md#af---27)**                                                   		       |
| **Назва :**            | Перегляд інформації бази даних клієнтом			 |
|**Учасники:**           | Система; Клієнт						 |
|**Передумови:**         | Запит на інформацію від клієнта до системи 			 |
|**Результат:**          | Надання інформації клієнту                     	         |
...
### 7.8 Сценарій «Запит клієнта на отримання допомоги по сервісу »

|                        |                                                               |
| -----------------------|---------------------------------------------------------------|
| **Ідентифікатор:**     | **[AF- 2.8](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/StakeholderRequests.md#af---28)**                                                  		       |
...
|**Результат:**          | Клієнт отримує відповідь     	                         |
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/1.1.png)
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/1.3.png)

### "AF - 1.4"

![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/1.4.png)
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/2.4.png)

### "AF - 2.5"

![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/2.5.png)
...
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/2.71.png)

### "AF - 2.8"
 
![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/2.81.png)

## 9. Діаграма бізнес-процесів

![alt text](https://github.com/mdapathy/databases/blob/master/%D0%94%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%B0%D1%86%D1%96%D1%8F/src/9.png)
...
• Адміністратор як найвищий виконавчий орган системи

###   10.2  Можливості зацікавлених осіб
### 10.2.1 Адміністратор

• Спостереження за системою, її оцінка

   • Оповіщення про роботу системи
   
   • Внесення змін в систему даних за підтвердженням Менеджера даних
   
   • Підтримка системи в робочому стані
    
### 10.2.2  Модератор

   • Постійний аналіз та коригування даних системи
   
   • Оповіщення Менеджера даних про необхідні зміни
   
   • Затвердження коректного виконання запитів Адміністратора
    
   • Маніпуляції з даними системи
    
### 10.2.3  Менеджер даних

   • Заповнення системи новими даними, їх форматування
   
   • Постійна взаємодія із Модератором
    
### 10.2.4  Менеджер ресурсів

   • Аналіз вхідних даних із зовнішніх джерел
   
   • Створення запитів на отримання/видалення інформації із системи
...
### 10.2.5  Клієнт
   ...
   • Зворотній зв’язок із Адміністратором системи
