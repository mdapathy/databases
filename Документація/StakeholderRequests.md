...
|**Основний сценарій:**  | 1. Адміністратор передає запит на створення нової бази даних модератору       |
|                        | 2.Модератор дає завдання на формування нової бази даних менеджеру даних  |
...
|		         | 4. Адміністратор передає запит модератору               |
...
|			 | 2. Адміністратор передає запит модератору                     |
