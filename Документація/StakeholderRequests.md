...
Права по керуванню системою належать **адміністратору**, що ,як виконавчий орган, здійснює інструкції по внесенню, редагуванню даних, спостереженню та екстреному доступу. В інших аспектах система діє *самодостатньо*, та накопичує дані своєї експлуатації. Клієнти ніяким чином не впливають на систему.


## 6. Сценарії бізнес-процесів

### 6.1 Сценарій «Додання нової інформації до сайту»
...
| **Назва :**            | Додання нової інформації до сайту                              |
|**Учасники:**           | Журналіст; Редактор; Адміністратор;                            |
|**Передумови:**         | Інформація, знайдена журналістом                               |
|**Результат:**          | Нова база даних                                                |
|**Виключні ситуації:**  | Нездатність забезпечити необхідною кількістю місця на сервері  |
|**Основний сценарій:**  | 1. Журналіст передає знайдену інформацію редактору.            |
|                        | 2. Редактор редагує отриману інформацію, формує базу даних     |
| 		         | 3. Редактор передає базу даних адміністратору                  |



### 6.2. Сценарій «Реєстрація веб-редактора»
...
| **Назва :**            | Реєстрація нового веб-редактора                                |
|**Учасники:**           | Головний редактор;Адміністратор;                  |
|**Передумови:**         | Коректно заповнені форми на реєстрацію                         |
|**Результат:**          | Профіль веб-редактора, права на редагування інформації         |
|**Виключні ситуації:**  | Некоректно заповненні форми                                    |
|**Основний сценарій:**  | 1. Готові форми головний редактор відправляє адміністратору.   |
...
|**Учасники:**           | Представник ресурсу даних; Головний редактор; Адміністратор;   |
|**Передумови:**         | Заява представника                                             |
|**Результат:**          | Видалення інформації                                           |
|**Виключні ситуації:**  | Некоректно   заповнена заява, відмова головного редактора      |
|**Основний сценарій:**  | 1. Представник ресурсу даних передає заяву головному редактору |
|			 | 2. Головний редактор опрацьовує запит                          |
|			 | 3. Головний редактор формує запит на видалення                 |
|		         | 4. Головній редактор передає запит адміністратору              |
|			 | 5. Адміністратор видаляє дані                                  |


### 6.4 Сценарій «Видалення інформації за запитом головного редактора»
...
|**Учасники:**           | Адміністратор; Головний редактор;                             |
|**Передумови:**         | Рішення головного редактора про видалення певного контенту    |
|**Результат:**          | Видалення даних                                               |
|**Виключні ситуації:**  | Відсутні                       				 |
|**Основний сценарій:**  | 1. Головний редактор формує запит   на видалення інформації   |
|			 | 2. Головний редактор передає запит адміністратору             |
|		         | 3. Адміністратор видаляє данні         			 |
...
1. Клієнтський інтерфейс з доступом до даних.

2. Сервер із базою даних.

3. Адміністратор як виконавчий орган редакторського складу сервісу.
...
### 10.2.1. Можливості Адміністратора.
