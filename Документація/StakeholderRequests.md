...
|			 | 3. Cистема надсилає інформацію модератору|
|			 | 4. Модератор надсилає системі підтвердження про оновлення  інформації|
|			 | 5. Система зберігає інформацію			 |
| 			 | 6. Система надсилає модератору повідомлення про поновлення інформації|
