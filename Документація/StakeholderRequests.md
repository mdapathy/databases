...
### 6.1 Сценарій «Додавання нової інформації до сайту»
...
| **Назва :**            | Додавання нової інформації до сайту                            |
...
|**Основний сценарій:**  | 1. Менеджер даних передає знайдену інформацію редактору.       |
|                        | 2. Модератор редагує отриману інформацію, формує базу даних    |
| 		         | 3. Модератор передає базу даних адміністратору                 |
