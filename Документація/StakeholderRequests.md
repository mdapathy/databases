...
|**Основний сценарій:**  | 1. Адміністратор надає запит системі на надання профілю прав	 |
| 			 | адміністратора.						 |
...
|			 | виконання запиту						 |
|			 | 5. Система надсилає повідомлення працівнику про отримання     |
|			 | прав адміністратора
